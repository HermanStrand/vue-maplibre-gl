...
<script>
  ...
  const { Popup, Point, LngLat } = maplibregl;

  /**
   * Component's props definition, we need to declare it outside the component
   * to be able to test the default values and the types.
   * @see  https://maplibre.org/maplibre-gl-js/docs/API/classes/Popup/
   * @type {object}
   */
  const propsConfig = {
    lngLat: {
   ...
   * @see  https://maplibre.org/maplibre-gl-js/docs/API/classes/Popup/#events
   * @type {Array}
   */
