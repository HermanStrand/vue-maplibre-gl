<template>
  <div :id="id">
    <MaplibreSource :id="sourceId" :options="source" />
    <MaplibreLayer
      :id="clustersLayer.id"
    ...
    <MaplibreLayer :id="clusterCountLayer.id" :options="clusterCountLayer" />
    <MaplibreLayer
...
<script>
  const propsConfig = {
     ...
     * @see  https://maplibre.org/maplibre-gl-js/docs/API/type-aliases/GeoJSONWorkerOptions/#clusterproperties
     * @see  maplibre.org/maplibre-gl-js/docs/examples/cluster-html/
     * @type {object}
     */
    clusterProperties: {
      type: Object,
     ...
     * @see  maplibre.org/maplibre-gl-js/docs/examples/cluster/
     * @type {object}
     */
    clustersLayout: {
      type: Object,
...
<script setup>
   ...
   * @param  {object} event The Maplibre click event's object
   * @returns {void}
   */
  function clustersClickHandler(event) {
    ...
    console.log(unref(map));
    console.log(unref(map).getSource(unref(sourceId)));
    unref(map)
   ...
   * @param  {object} event The Maplibre mouseenter event's object
   * @returns {void}
   */
   ...
   * @param  {object} event The Maplibre mouselvea event‘s object
   * @returns {void}
   */
